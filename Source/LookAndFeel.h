...
public:
	...
	void drawButtonBackground(juce::Graphics& g, juce::Button& button, const juce::Colour& backgroundColour, bool shouldDrawButtonHighlighted, bool shouldDrawButtonAsDown) override;
